        ...
        else
        {
            for( unsigned int run = 0 ; run < num_line ; run++ )
            {
                *file_object >> str_collect;
                ...
                thruster_force[ ( run * 6 ) + 0 ] = std::atof( str_array[ 0 ].c_str() );
                thruster_force[ ( run * 6 ) + 1 ] = std::atof( str_array[ 1 ].c_str() );
                thruster_force[ ( run * 6 ) + 2 ] = std::atof( str_array[ 2 ].c_str() );
                thruster_force[ ( run * 6 ) + 3 ] = std::atof( str_array[ 3 ].c_str() );
                thruster_force[ ( run * 6 ) + 4 ] = std::atof( str_array[ 4 ].c_str() );
                thruster_force[ ( run * 6 ) + 5 ] = std::atof( str_array[ 5 ].c_str() );
                euler_robot[ ( run * 3 ) + 0 ] = std::atof( str_array[ 6 ].c_str() );
                euler_robot[ ( run * 3 ) + 1 ] = std::atof( str_array[ 7 ].c_str() );
                euler_robot[ ( run * 3 ) + 2 ] = std::atof( str_array[ 8 ].c_str() );
                angular_velocity[ ( run * 3 ) + 0 ] = std::atof( str_array[ 9 ].c_str() );
                angular_velocity[ ( run * 3 ) + 1 ] = std::atof( str_array[ 10 ].c_str() );
                angular_velocity[ ( run * 3 ) + 2 ] = std::atof( str_array[ 11 ].c_str() );
                angular_accel[ ( run * 3 ) + 0 ] = std::atof( str_array[ 12 ].c_str() );
                angular_accel[ ( run * 3 ) + 1 ] = std::atof( str_array[ 13 ].c_str() );
                angular_accel[ ( run * 3 ) + 2 ] = std::atof( str_array[ 14 ].c_str() );
            }
            success = true;
        }
        return success;
